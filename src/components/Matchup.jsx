...
export default function Matchup() {
  ...
  const rows = ROWS.map((r) => {
    ...
    if (!a || !b) return null
    return { ...r, a, b, edge: r.lowerBetter ? a.value < b.value : a.value > b.value }
  }).filter(Boolean)
  ...
  const side = (s, edge, align) => (
    <div style={{ width: 130, textAlign: align, flexShrink: 0 }}>
