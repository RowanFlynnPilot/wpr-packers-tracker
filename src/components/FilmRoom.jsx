              ...
              <div style={{ display: 'flex', gap: 18, flexWrap: 'wrap', marginTop: 22 }}>
                {leaders.map((l) => (
                  <div key={l.cat} style={{ display: 'flex', alignItems: 'center', gap: 8, flex: '1 1 170px' }}>
                    <img src={headshot(l.id, 32)} alt="" width={32} height={32} loading="lazy" decoding="async" style={{ borderRadius: '50%', objectFit: 'cover', background: theme.wash, flexShrink: 0 }} onError={(e) => { e.currentTarget.style.display = 'none' }} />
